    ...
    return (
        <div>
            ...
            <CheckableHeading title="Netz eines Kegels">
                ...
                Kegels aufzuzeichnen, weil er neben der Kreisseite keine Kante
                hat. Genau das erleichtert uns aber die Arbeit, denn so können
                wir den Kegel <b>abrollen</b>. Schau dir das Video dazu an!
            ...
            <CheckableHeading title="Oberfläche">
                ...
                Kegels haben wir aber noch einen <b>Kreisausschnitt</b>{" "}
                bekommen! Wir markieren uns, wie weit der Kegel mit genau einer
                Umdrehung kommt. Genau diese Fläche entspricht der{" "}
                <b>Mantelfläche</b> des Kegels. Der Radius des „Abrollkreises“
                entspricht der Höhe{" "}
                <Mark c={"desblue"}>
                ...
                <CheckableBlockquote
                    ...
                    titleOrder={2}
                >
                    Mit der Info kannst du nun auch Netze zeichnen. Zeichne von
                    den folgenden Zylindern die Netze auf:
                    <Image
                    ...
                    >
                        ...
                        <List type="ordered">
                            <ListItem>
                                ...
                                <InlineMath>M</InlineMath> berechnen:
                                <BlockMath>
                                    {String.raw`
                                \begin{aligned}
            ...
            <CheckableHeading title="Volumen">
                Im Gegensatz zur Oberfläche ist das Volumen eines Kegels nicht
                wirklich intuitiv berechnbar. Stattdessen werden wir uns eine
                Formel dafür herleiten. Dafür müssen wir uns Pyramiden
                anschauen!
                <CheckableHeading title="Volumen einer Pyramide" titleOrder={2}>
                    Wir konstruieren uns eine quadratische Pyramide in einem
                ...
                <CheckableHeading title="Volumen eines Kegels" titleOrder={2}>
                    ...
                    <InlineMath>V</InlineMath> berechnet sich immer nach{" "}
                    <InlineMath>{String.raw`V = \frac{1}{3}Gh_\text{Pyramide}`}</InlineMath>
                    .
                    <CheckableBlockquote
                        icon="frage"
                        title="Aufgabe: Von der Pyramide zum Kegel"
                        titleOrder={2}
                    >
                        Damit hast du alle Informationen, um dir herzuleiten,
                        wie sich das Volumen eines Kegels berechnen lässt. Halte
                        deine Überlegungen in Form von Skizzen und einem
                        Erklärtext fest!
                        <Lösung
                            title="Lösung"
                            titleOrder={3}
                            id="Lösung-Kegelvolumen"
                        >
                            <Image
                                h={{ base: "auto", md: 325 }}
                            ...
                            />
                            Fügen wir zu einer Pyramide immer mehr Ecken hinzu,
                            so ähnelt die Grundfläche immer mehr einem Kreis.
                            Das 24-Eck ist z.B. optisch fast nicht mehr von
                            einem Kreis zu unterscheiden. Fügen wir immer mehr
                            und mehr Ecken hinzu, gelangen wir nach unendlich
                            vielen Ecken tatsächlich beim Kreis an – die
                            Volumenformel für die Pyramide hat sich dabei jedoch
                            nicht geändert. Also gilt sie auch für einen Kegel!
                        </Lösung>
                    </CheckableBlockquote>
                    <CheckableBlockquote
                        title="Aufgabe: Ausbau eines Dachstuhls"
                        icon="frage"
                    >
                        Ein Hausbesitzer möchte seinen Dachstuhl renovieren. Der
                        Turm hat einen Durchmesser von 6{thinsp}m, das Dach hat
                        eine Höhe 5,5{thinsp}m.
                        <Image
                            src="/Kegel/DachKegel.jpg"
                            width={6000}
                            height={4000}
                            alt="Ein Bild von einem kegelförmigen Dach."
                        />
                        <List type="ordered">
                            <ListItem>
                                Beurteile anhand der Grundfläche und des
                                Volumens, ob der Dachboden als Zimmer genutzt
                                werden kann. Wenn ja, welches Zimmer kannst du
                                dir dort vorstellen? Vergiss dabei nicht, dass
                                das Dach auch gedämmt werden muss!
                            </ListItem>
                            <ListItem>
                                Nach einem schweren Unwetter muss das Dach neu
                                gedeckt werden, da Feuchtigkeit eindringt. Dafür
                                sollen Zinkbleche verwendet werden, die pro m
                                <sup>2</sup> 65€ kosten. Der Dachdecker verlangt
                                noch einmal 40€ pro m<sup>2</sup> an
                                Arbeitskosten. Berechne die Gesamtkosten.
                            </ListItem>
                        </List>
                        <Lösung
                            title="Lösung"
                        ...
                        >
                            <List type="ordered">
                                <ListItem>
                                    ...
                                    <MBlockMath
                                        desktop="\begin{aligned}
                                        G &= \pi r^2 &&\lvert r = \frac{d}{2} \\
                                    ...
                                    <MBlockMath
                                        desktop="\begin{aligned}
                                        V &= \frac{1}{3}Gh &&\lvert G = 28{,}27\,\text{m}^2, h = 5{,}5\,\text{m} \\
                                    ...
                                    &\Downarrow \scriptsize{G = 28{,}27\,\text{m}^2, h = 5{,}5\,\text{m}} \\
                                        ...
                                        &\Rightarrow V = 51{,}84\,\text{m}^3"
                                    />
                                    Zum Vergleich: Ein Zimmer mit einer
                                    Grundfläche von 3 mal 4{thinsp}m und einer
                                    Höhe von 2,5{thinsp}m hat eine Fläche von{" "}
                                    <InlineMath>{String.raw`3\,\text{m}\cdot 4\,\text{m} = 12\,\text{m}^2`}</InlineMath>
                                    und ein Volumen von{" "}
                                    <InlineMath>{String.raw`12\,\text{m}^2 \cdot 2{,}5\,\text{m} = 30\,\text{m}^3`}</InlineMath>
                                    . Der Dachstuhl kann also sicherlich noch
                                    als Zimmer verwendet werden, auch wenn die
                                    Dachschräge viel vom Stehplatz wegnimmt.
                                </ListItem>
                                <ListItem>
                                    Höhe des Mantels berechnen:
                                    <MBlockMath
                                        desktop="\begin{aligned}
                                        h_\text{Mantel} &= \sqrt{r^2 + h^2} &&\lvert r = 3\,\text{m},\; h = 5{,}5\,\text{m} \\
                                    ...
                                    <MBlockMath
                                        desktop="\begin{aligned}
                                        M &= \frac{U}{2} \cdot h_\text{Mantel} &&\lvert U = 2\pi r ,\; h_\text{Mantel} = 6{,}26\,\text{m} \\
                                    ...
                                    <sup>2</sup>. Pro Quadratmeter muss 65€ für
                                    das Zinkblech und weitere 40€ für die Arbeit
                                    ausgegeben werden. Insgesamt also{" "}
                                    <InlineMath>65€ + 40€= 105€</InlineMath>.
                                    Das bedeutet in unserem Fall:
                                    <BlockMath>
                                        {String.raw`59\,\text{m}^2 \cdot 105\frac{€}{\text{m}^2} = 6195€`}
                                    </BlockMath>
