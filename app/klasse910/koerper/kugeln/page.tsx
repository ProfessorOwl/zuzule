            ...
            <CheckableHeading title="Volumen">
                ...
                <CheckableHeading title="Herleitung des Kugelvolumens" titleOrder={2}>
                    ...
                    <List>
                        ...
                        <ListItem>
                            <b>Fläche im Halbkreis:</b> Hier müssen wir den Satz des Pythagoras einsetzen, um nach <InlineMath math="\textcolor{#A39215}{r_\text{K}}" /> aufzulösen.
                            <MBlockMath desktop="\textcolor{#3012B8}{x}^2 + \textcolor{#A39215}{\textcolor{#A39215}{r_\text{K}}}^2 &= \textcolor{#0D8762}{r}^2 &&\lvert -\textcolor{#3012B8}{x}^2 \\ \textcolor{#A39215}{r_\text{K}}^2 &= \textcolor{#0D8762}{r}^2 - \textcolor{#3012B8}{x}^2 &&\lvert \sqrt{} \\ \textcolor{#A39215}{r_\text{K}} &= \sqrt{\textcolor{#0D8762}{r}^2 - \textcolor{#3012B8}{x}^2}" mobile="\textcolor{#3012B8}{x}^2 + \textcolor{#A39215}{r_\text{K}}^2 &= \textcolor{#0D8762}{r}^2 \\ &Downarrow \scriptsize{-\textcolor{#3012B8}{x}^2} \\ \textcolor{#A39215}{r_\text{K}}^2 &= \textcolor{#0D8762}{r}^2 - \textcolor{#3012B8}{x}^2 \\&Downarrow \scriptsize{\sqrt{}} \\ \textcolor{#A39215}{r_\text{K}} &= \sqrt{\textcolor{#0D8762}{r}^2 - \textcolor{#3012B8}{x}^2}" />
                            Nun nutzen wir die normale Flächenformel für einen Kreis, um auf die Fläche <InlineMath math="A_\text{K}" /> zu kommen:
                            <BlockMath math="A_\text{K} &= \pi \textcolor{#A39215}{r_\text{K}}^2 \\ &=\pi \cdot \left(\sqrt{\textcolor{#0D8762}{r}^2 - \textcolor{#3012B8}{x}^2}\right)^2 \\ &= \pi (\textcolor{#0D8762}{r}^2 - \textcolor{#3012B8}{x}^2) \\ &= \pi \textcolor{#0D8762}{r}^2 - \pi \textcolor{#3012B8}{x}^2" />
