        ...
        <Fragment>
            ...
            <CheckableHeading title="Volumen">
                ...
                <CheckableHeading title="Herleitung des Kugelvolumens" titleOrder={2}>
                    ...
                    Das Volumen der Halbkugel entspricht also <InlineMath math="V_\text{Halbkugel} = \frac{2}{3}\pi \textcolor{#12B886}{r}^3" />
            ...
            <CheckableHeading title="Oberfläche">
                ...
                entspricht:
                <MBlockMath
                    desktop="\frac{4}{3}\pi \textcolor{#12B886}{r}^3 &= \frac{1}{3}G_1\textcolor{#12B886}{r} + \frac{1}{3}G_2\textcolor{#12B886}{r} + \ldots + \frac{1}{3}G_n\textcolor{#12B886}{r} &&\lvert \cdot 3 \\
                    ...
                    mobile="\frac{4}{3}\pi \textcolor{#12B886}{r}^3 &= \frac{1}{3}G_1\textcolor{#12B886}{r} + \frac{1}{3}G_2\textcolor{#12B886}{r} + \ldots + \frac{1}{3}G_n\textcolor{#12B886}{r} \\ &\Downarrow \scriptsize{\cdot 3} \\
                    4\pi \textcolor{#12B886}{r}^3 &= G_1\textcolor{#12B886}{r} + G_2\textcolor{#12B886}{r} + \ldots + G_n\textcolor{#12B886}{r} \\ &\Downarrow \scriptsize{:3} \\
                    4\pi \textcolor{#12B886}{r}^2 &= G_1 + G_2 + \ldots + G_n"
                />
            ...
            <CheckableBlockquote icon="frage" title="Aufgabe: Planetenvergleich" titleOrder={2}>
                ...
                <List type="ordered">
                    ...
                    <ListItem>Die Himmelskörper haben verschiedene Dichten <InlineMath math="\rho"/>. 
                        <BlockMath math="\rho_\text{Erde} & = 5{,}5\frac{\text{g}}{\text{cm}^3} \\
                ...
                <List type="ordered">
                    <ListItem>
                        ...
                        <BlockMath math="O_\text{Erde} &= 4 \pi \cdot( 6371\,\text{km})^2 \\
                    ...
                    <ListItem>
                        ...
                        <BlockMath math="V_\text{Erde} &= \frac{4}{3}\pi \cdot( 6371\,\text{km})^3 \\ 
                        ...
                        <BlockMath math="V_\text{Erde} &= 1.083.206.917.000\,\text{km}^3 \\
                    ...
                    <ListItem>
                        ...
                        <BlockMath math="\frac{\text{g}}{\text{cm}^3} &= \frac{10^{-6}\,\text{t}}{\left(10^{-5}\,\text{km}\right)^3} \\
                        ...
                        <BlockMath math="m_\text{Erde} &= 1,08 \cdot 10^{12}\,\text{km}^3 \cdot 5{,}5 \cdot  10^9\,\frac  {\text{t}}{\text{km}^3} \\
