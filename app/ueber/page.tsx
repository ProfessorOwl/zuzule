...
export default function Ueber() {
    return <Fragment>
       ...
       „Zurück zum Lehrer“ oder auch <b>zuzule</b> ist eine Lernwebsite, die es ermöglicht, Online-Lerninhalte gezielt im Unterricht einsetzen zu können. Sie wird im Rahmen einer Masterarbeit gestaltet und beinhaltet im Moment Geometrie und Körper als Themen.
        ...
        Jedes Kapitel lässt sich mit dem Kästchen neben dem Titel aus- und ausklappen. Diese Änderung wird auch in der Kapitelübersicht rechts reflektiert. Durch Klicken auf den Button „Inhalte freigeben“ oben rechts werden die gemachten Änderungen festgehalten und eingeklappte Kapitel vollständig ausgeblendet. Der Link dieser Seite kann nun an die Lerngruppe weitergegeben werden, sodass eine personalisierte Websiteerfahrung gewährleistet werden kann.
        </Fragment>;
}
