...
export default function Ueber() {
    return (
        <Fragment>
            ...
            Die meisten Lernwebsites sind übersät mit unnötigen Inhalten wie Werbung, Anmeldeaufforderungen, unübersichtlichen Inhaltsvorschläge, etc. Die Aufgabenvielfalt ist auf diesen Seiten häufig nicht besonders groß – dadurch benötigen sie entweder zu viel Vorwissen oder gehen nicht tief genug in die Thematik herein. Ein letzter Punkt ist die fehlende Kontrolle über die Inhalte. Mit der Lerngruppe kann nur die ganze Website geteilt werden. Lösungen, unnötige oder ablenkende Inhalte können nicht ausgeblendet werden.
            <Space />
            ...
            <Box visibleFrom="md">
                ...
                <Divider />
                <SimpleGrid cols={2}>
                    <Box>Durch Klicken auf den Button „Inhalt freigeben“ oben rechts werden die gemachten Änderungen festgehalten und eingeklappte Kapitel vollständig ausgeblendet. Der Link zu dieser Seite kann nun an die Lerngruppe weitergegeben werden, sodass eine personalisierte Websiteerfahrung gewährleistet werden kann.</Box>
                    <video width={"100%"} autoPlay loop>
