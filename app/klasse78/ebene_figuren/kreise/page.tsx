...
export default function Kreise() {
    return (
        <Fragment>
            <CheckableHeading title="Der Kreis"> Kreise sind mathematisch schöne Formen: Man muss nur einen Mittelpunkt festlegen und einen Radius nennen, und heraus kommt ein ganzer Kreis! Auch im Alltag begleiten uns kreisförmige Sachen überall, sei es dein Kleingeld im Geldbeutel, Autoreifen oder runde Stifte. Auf dieser Seite wirst du mehr darüber erfahren, wie der Flächeninhalt und Umfang von Kreisen berechnet werden kann. Erstmal aber: Was macht einen Kreis überhaupt aus?</CheckableHeading>
            <CheckableHeading title="Definition" titleOrder={2}>
                Ein Kreis ist eine Figur, bei der alle Punkte den gleichen Abstand vom Mittelpunkt haben. Dieser Abstand wird allgemein <b>Radius</b> genannt. <br />
            ...
            <CheckableHeading title="Umfang">
                ...
                Die Tasse hier hat einen Durchmesser von <InlineMath math="9{,}8\,\text{cm}" /> und einen Umfang von <InlineMath math="31\,\text{cm}" />. Wir können davon das Verhältnis berechnen! Wir werden später feststellen, dass das bei Kreisen sehr wichtig ist.
                ...
                <CheckableBlockquote title="Aufgabe: Verhältnis zwischen Durchmesser und Umfang" titleOrder={2} icon="frage">
                    ...
                    Es ist kein Problem, wenn du kein Maßband hast. Nimm dann eine Schnur oder etwas anderes Biegsames und lege es um den runden Gegenstand. Mit einem Geodreieck oder Lineal kannst du dann ausmessen, wie viel sich davon um den Gegenstand legen ließ.
                ...
                <CheckableBlockquote icon="aha" title="Aha! Zahlenfolgen in π" titleOrder={2}>
                    ...
                    -ten Stelle, wenn die Buchstaben in Zahlen übersetzt werden, also A=1, B=2, … gewählt wird.
                </CheckableBlockquote>
                Da das Verhältnis zwischen dem Umfang <InlineMath>U</InlineMath> und dem Durchmesser <InlineMath>d</InlineMath> der Zahl <InlineMath>\pi</InlineMath> entspricht, können wir das auch so festhalten:
                <BlockMath math="\frac{U}{d} &= \pi &&\lvert \cdot d \\ U &= d \cdot \pi" /> Oft wird dabei statt dem Durchmesser auch der Radius <InlineMath>r</InlineMath> benutzt, der genau der Hälfte des Durchmessers entspricht. Dann lautet die Formel:
                <BlockMath math="U = 2\pi r" />
                <CheckableBlockquote title="Aufgabe: Umfang" icon="frage" titleOrder={2}>
                    Berechne immer entweder <InlineMath>r</InlineMath> oder <InlineMath>U</InlineMath> und zeichne die Kreise in der richtigen Größe auf.
                    <List type="ordered">
                        <ListItem>
                    ...
                    <Hinweis id="hinweis-umfang" titleOrder={3}>
                        Stelle die Gleichung von oben sowohl nach <InlineMath>r</InlineMath>, als auch nach <InlineMath>U</InlineMath> um!
                    </Hinweis>
                    <Lösung titleOrder={3} id="lösung-umfang">
                        Die Gleichung nach <InlineMath>U</InlineMath> umgestellt lautet: <InlineMath math="U = 2\pi r" />, nach <InlineMath>r</InlineMath> umgestellt: <BlockMath math="U &= 2\pi r &&\lvert : 2\pi \\ \frac{U}{2\pi} &= r" />. Dann müssen nur noch die richtigen Werte eingesetzt werden.
                        <List type="ordered">
                            <ListItem>
            ...
            <CheckableHeading title="Flächeninhalt">
                ...
                Du kannst sie aber noch weiter zerteilen! Wenn du sie als 16-tel nebeneinander legst, dann bekommst du fast ein Rechteck:
                ...
                <CheckableBlockquote icon="frage" title="Aufgabe: Flächeninhalt" titleOrder={2}>
                    Berechne den Flächeninhalt der folgenden Kreise mit Radius <InlineMath>r</InlineMath>r und Durchmesser <InlineMath>d</InlineMath>:
                    <List type="ordered">
                        <ListItem>
                            <InlineMath math="r = 2\,\text{cm}" />
                        </ListItem>
