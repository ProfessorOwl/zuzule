                ...
                <Lösung title="Lösung" titleOrder={2} id="Lösung-Zusammen">
                    <List type="ordered">
                        <ListItem>
                            ...
                            <BlockMath
                                math="V_\text{Quader} &= 9 \cdot 7 \cdot 4 \\
                        &= 252"
                            />
                            Der Zylinder hat die gleiche Höhe:
                            <BlockMath
                                math="V_\text{Zylinder} &= \pi \textcolor{#B81E46}{r}^2 h \\
                        &= \pi \cdot \textcolor{#B81E46}{2}^2 \cdot 4 \\
                        &\approx 50{,}27"
                            />
                            Das korrekte Volumen bekommen wir durch subtrahieren der beiden Volumina:
                            <BlockMath
                                math="V_\text{gesamt} &= V_\text{Quader}-V_\text{Zylinder} \\
                        &= 252 - 50{,}27 \\
                        &= 201{,}73"
                            />
                        </ListItem>
                        <ListItem>
                            Es gibt mehrere Arten, das Volumen dieses Körpers zu berechnen. Eine Methode ist, zuerst die zu uns zeigende Fläche zu berechnen, und diese dann als Prisma in die Höhe zu ziehen. Die Fläche vorne ist ein Rechteck mit einem Dreieck. Fläche des Rechtecks:
                            <BlockMath
                                math="A_\text{Rechteck} &= 3 \cdot 4 \\
                        &= 12"
                            />
                            Das Dreieck berechnet sich aus der Reststrecke und der Höhe:
                            <BlockMath
                                math="A_\text{Dreieck} &= \frac{1}{2} \cdot 3 \cdot 6 \\
                        &= 9"
                            />
                            Damit ergibt sich die Gesamtfläche zu
                            <BlockMath
                                math="A &= A_\text{Dreieck} + A_\text{Rechteck} \\
                        &= 9 + 12 \\
                        &= 21"
                            />
                        ...
                        \frac{U}{2\pi} &= r \\
                        &\Rightarrow r = \frac{\textcolor{#B81E46}{6}}{2\pi} = 0{,}95"
                                mobile="U &= 2\pi r \\
                    &\Downarrow \scriptsize{:2\pi} \\
                        ...
                        &\Rightarrow r = \frac{\textcolor{#B81E46}{6}}{2\pi} = 0{,}95"
                            ...
                            <BlockMath
                                math="V_\text{Zylinder} &= \pi r^2 h \\
                        &= \pi \cdot 0{,}95^2 \cdot 5{,}5 \\
                        &= 15{,}59"
                            />
                            Das Volumen des Quaders ergibt sich nun folgendermaßen:
                            <BlockMath
                                math="V_\text{Quader} &= \textcolor{#3012B8}{3} \cdot 5{,}5 \cdot (2\cdot 0{,}95) \\
                        &= 31{,}35"
                            />
                            Zusammen ergibt das:
                            <BlockMath
                                math="V_\text{gesamt} &= V_\text{Zylinder} + V_\text{Quader} \\
                        &= 15{,}59 + 31{,}35 \\
                        &= 46{,}94"
                            />
                        </ListItem>
                ...
                <Lösung title="Lösung" titleOrder={2} id="Lösung-Flasche">
                    <List type="ordered">
                        <ListItem>
                            ...
                            <BlockMath
                                math="V_\text{gesamt} &= V_\text{außen} - V_\text{innen} \\
